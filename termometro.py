class Termometro:
    ...
    def converte_para_celsius(self):
        if self.unidade_medida == 'F':
            return (self.temperatura - 32) * 5 / 9
        elif self.unidade_medida == 'K':
            return self.temperatura - 273.15
        else:
            return self.temperatura
        
    def converte_para_fahrenheit(self):
        if self.unidade_medida == 'C':
    ...
    def converte_para_kelvin(self):
        if self.unidade_medida == 'C':
            return self.temperatura + 273.15
        elif self.unidade_medida == 'F':
